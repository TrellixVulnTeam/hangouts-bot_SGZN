...
PERSONACHAT_URL = (
    "https://s3.amazonaws.com/datasets.huggingface.co/personachat"
    "/personachat_self_original.json"
)
HF_FINETUNED_MODEL = (
    "https://s3.amazonaws.com/models.huggingface.co/transfer-learning-chatbot"
...
def make_logdir(model_name: str):
    ...
    return os.path.join(
        "runs", f"{current_time}_{socket.gethostname()}_{model_name}"
    )
